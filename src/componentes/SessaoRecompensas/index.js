    ...
    return (
        <section className='containerReco'>
            ...
            <article className='textosPremios'>
                <p className='p1'>
                    Caso você tenha alguma ideia de inovação e melhoria para a Fórmula E, você tem a oportunidade de enviar às escuderias da competição e concorrer a prémios.
                </p>
                <p className='p2'>
