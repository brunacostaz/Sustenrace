        ...
        <div className="dropdown-containerComparacao"> 
            <div className="dropdownComparacao">
                ...
                <div className="dropdown-contentComparacao">
                    <button onClick={() => showPopup('pneu')}>Pneu</button>
                    <button onClick={() => showPopup('motor')}>Motor</button>
                    <button onClick={() => showPopup('chassi')}>Chassi</button>
                </div>
            </div>
            <div className="dropdownComparacao">
                <button className="dropbtnComparacao">Principais Diferenças</button>
                <div className="dropdown-contentComparacao">
                    <button onClick={() => showPopup('velocidade')}>Velocidade</button>
                    <button onClick={() => showPopup('comprimento')}>Comprimento</button>
                    <button onClick={() => showPopup('potencia')}>Potência</button>
                    <button onClick={() => showPopup('peso')}>Peso</button>
                </div>
            </div>
            <div className="dropdownComparacao">
                <button className="dropbtnComparacao">Diferenciais FE</button>
                <div className="dropdown-contentComparacao">
                    <button onClick={() => showPopup('bateria')}>Bateria</button>
                    <button onClick={() => showPopup('software')}>Sotware</button>
                    <button onClick={() => showPopup('padronizacao')}>Padronização</button>
                    <button onClick={() => showPopup('tecnologia')}>Tecnologia</button>
                </div>
            </div>
        </div>
